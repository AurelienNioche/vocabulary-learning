...
from vocabulary_learning.core.file_operations import load_vocabulary, load_progress, save_progress
from vocabulary_learning.core.progress_tracking import update_progress, count_active_learning_words
...
from vocabulary_learning.core.ui_components import show_progress, show_word_statistics, show_save_status, show_help
from vocabulary_learning.core.vocabulary_management import add_vocabulary, reset_progress
from vocabulary_learning.core.utils import signal_handler, normalize_french
...
def main():
    ...
    practice_mode(learner.vocabulary, learner.progress, learner.console, learner.japanese_converter, 
                 lambda word, success: update_progress(word, success, learner.progress, learner.save_progress),
    ...
    while True:
        ...
        if choice == '1':
            ...
            add_vocabulary(learner.vocab_file, learner.vocabulary, learner.vocab_ref, learner.console, 
                         lambda: load_vocabulary(learner.vocab_file, learner.vocab_ref, learner.console))
        elif choice == '4':
            reset_progress(learner.progress_file, learner.progress_ref, learner.progress, learner.save_progress, learner.console)
        elif choice == ':q':

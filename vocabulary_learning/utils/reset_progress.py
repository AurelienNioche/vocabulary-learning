...
def reset_progress():
    ...
    if not Confirm.ask("[bold red]Are you absolutely sure you want to reset all progress?[/bold red]"):
        console.print("[yellow]Operation cancelled.[/yellow]")
        return
    
    if not Confirm.ask("[bold red]This will delete ALL your learning progress. Type 'y' to confirm:[/bold red]"):
        console.print("[yellow]Operation cancelled.[/yellow]")
        return
    ...
    if not os.path.exists(cred_path):
        ...
        console.print("[yellow]Local progress has been reset, but Firebase could not be updated.[/yellow]")
        return
    ...
    try:
        ...
        console.print("[yellow]Local progress has been reset, but there was an error updating Firebase.[/yellow]")
